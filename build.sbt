...
val storm_version = "0.10.0"
val esper_version = "5.3.0"
...
libraryDependencies ++= Seq(
    ...
    "org.apache.storm" % "storm-core" % storm_version,
    "org.apache.storm" % "storm-kafka" % storm_version,
    "org.apache.storm" % "storm-hbase" % storm_version,
    "org.apache.storm" % "storm-hdfs" % storm_version,
    "org.apache.storm" % "multilang-python" % storm_version,
    "org.apache.storm" % "multilang-ruby" % storm_version,
    "org.apache.storm" % "multilang-javascript" % storm_version,
    "org.apache.storm" % "flux-wrappers" % storm_version,
    "org.apache.storm" % "storm-eventhubs" % storm_version,
    "org.apache.storm" % "storm-jdbc" % storm_version,
    "org.apache.storm" % "storm-hive" % storm_version,
    "org.apache.storm" % "storm-redis" % storm_version,
    "org.apache.storm" % "flux-core" % storm_version,
    "org.apache.storm" % "flux" % storm_version,
    "org.apache.storm" % "storm-starter" % storm_version,

    "com.espertech" % "esper" % esper_version,
    "com.espertech" % "esperio-amqp" % esper_version,
    "com.espertech" % "esperio-db" % esper_version,
    "com.espertech" % "esperio-stax" % esper_version,
    "com.espertech" % "esperio-springjms" % esper_version,
    "com.espertech" % "esperio-http" % esper_version,
    "com.espertech" % "esperio-socket" % esper_version,
    "com.espertech" % "esperio-csv" % esper_version,
...
excludeDependencies += "org.mule.extensions" % "mule-extensions-api"
excludeDependencies += "org.mule.mvel" % "mule-mvel2"
excludeDependencies += "net.java.dev.stax-utils" % "stax-utils"
excludeDependencies += "javax.xml.xquery" % "xqj-api"
excludeDependencies += "com.yourkit" % "yjp-controller-api-redist"
excludeDependencies += "org.mule.modules" % "mule-module-validation"
excludeDependencies += "javax.script" % "js-engine"
excludeDependencies += "javax.script" % "jruby-engine"
excludeDependencies += "org.mule.common" % "mule-common"
excludeDependencies += "eigenbase" % "eigenbase-properties"
excludeDependencies += "net.hydromatic" % "linq4j"
excludeDependencies += "net.hydromatic" % "quidem"
